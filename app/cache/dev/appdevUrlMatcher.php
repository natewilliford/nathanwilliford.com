...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // nate_user_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Nate\\UserBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'nate_user_default_index'));
        }
        ...
        // nate_portfolio_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Nate\\PortfolioBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'nate_portfolio_default_index'));
        }
